...
--
-- Host: 127.0.0.1    Database: gestor_recetas
-- ------------------------------------------------------
...
CREATE TABLE `feedback` (
  ...
  CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`idReceta`) REFERENCES `recetas` (`idReceta`)
...
-- Dump completed on 2025-10-30 21:45:36
